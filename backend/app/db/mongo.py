"""
CYBER AI — Async MongoDB Client (Motor)
Provides:
...
def get_mongo_db_optional() -> AsyncIOMotorDatabase | None:
    """
    Return the active Motor database handle if available, or None if MongoDB is offline.
    Allows endpoints to degrade gracefully without failing.
    """
    return _mongo_db
