"""
CYBER AI — FastAPI Application Entry Point
"""
...
from app.api.v1.endpoints import ueba as ueba_router
...
# Module 7 — UEBA Intelligence Engine
app.include_router(ueba_router.router,      prefix=API_PREFIX)
