...
def get_employee_intelligence(
    ...
    if psychometric:
        ...
        psychometric_data = PsychometricIntelligence(
            ...
            openness=int(
                psychometric.openness or 0
            ),

            conscientiousness=int(
                psychometric.conscientiousness or 0
            ),

            extraversion=int(
                psychometric.extraversion or 0
            ),

            agreeableness=int(
                psychometric.agreeableness or 0
            ),

            neuroticism=int(
                psychometric.neuroticism or 0
            )
        )
    ...
    try:
        ...
        # Try to use an already stored risk record
        ...
        if stored_risk:
            ...
            risk_data = RiskIntelligence(
                risk_score=int(
                    stored_risk.risk_score or 0
                ),

                risk_level=str(
                    stored_risk.risk_level or "LOW"
                ),
                ...
                explanation=(
                    "Risk score loaded from the "
                    "stored employee risk record."
                )
            )
