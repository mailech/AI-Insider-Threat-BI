...
// ── Default Weights (CYBER AI Weighted Threat Model) ─────────────────────────────
...
export default function SettingsPage() {
  ...
  // Tab 2: Threat Scoring Weights (Exact CYBER AI Weighted Model)
  ...
  function handleRestoreDefaults() {
    ...
    showToast('✓ Threat scoring weights reset to official CYBER AI specification (100%)', 'info');
  }
        ...
        <div className="animate-fade-in">
          {!canConfigScoring ? (
            ...
            <CardSection
              ...
              subtitle="Weighted scoring parameters according to the CYBER AI threat detection model (Sum must equal 100%)"
              badge={
                <button
