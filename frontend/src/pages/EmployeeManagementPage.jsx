...
import { Users, UserPlus, Search, Filter, Laptop, Lock, ShieldAlert, RefreshCw } from "lucide-react";
    ...
    <div className="p-6 max-w-[1400px]">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-medium hover:bg-slate-800 transition-colors"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-bold hover:brightness-110 shadow-lg shadow-cyan-500/20"
          >
            <UserPlus size={15} />
            + Onboard Employee
          </button>
      ...
      <div style={{ background: palette.surface, border: `1px solid ${palette.line}` }} className="p-4 rounded-xl mb-6 flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <span className="text-xs font-bold text-white uppercase tracking-wider mr-2">Department Mapping:</span>
              ...
              >
                ...
                <td className="py-3.5 px-4">
                  <button
                    ...
                    className="px-2.5 py-1 rounded text-[11px] font-semibold text-cyan-400 hover:bg-slate-800"
                  >
                    View Details
                  </button>
                </td>
