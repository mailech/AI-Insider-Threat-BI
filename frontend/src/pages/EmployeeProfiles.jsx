...
function EmployeeProfiles() {
  ...
  async function loadEmployees() {
    ...
    try {
       ...
       *   [...]
       *
       * Normalize all supported response shapes into an array.
       */
      let employeeList = [];
  ...
  // Select the employee immediately
  setSelectedEmployee(employee);

  // Clear previous intelligence
  ...
  try {
    ...
    if (!response.ok) {
      ...
      if (response.status === 404) {
        throw new Error(
          `Employee ${employee.employee_id} was not found.`
        );
      }
    ...
    // Update employee information returned by backend
    if (data.employee) {
    ...
    // Store complete intelligence response
    setIntelligence(data);

    // Scroll to Employee Intelligence section
    setTimeout(() => {
  ...
  >
            ...
            ) : intelligence && intelligence.employee ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    <div className="bg-slate-800 rounded-xl p-5">
                      ...
                      <p className="text-cyan-400 font-semibold mt-2">
                        {intelligence?.employee?.employee_id || selectedEmployee?.employee_id || "-"}
                      </p>
